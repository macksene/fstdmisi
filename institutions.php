...
?>
    ...
    <section class="banner_area" data-stellar-background-ratio="0.5">
        <h2>LES INSTITUTIONS PUBLIQUES PARTENAIRES</h2>
        <ol class="breadcrumb">
            <li><a href="index.html">Accueil</a></li>
            <li><a href="#" class="active">Institutions</a></li>
        </ol>
    </section>
    <!-- End Banner area -->
    ...
    <section class="blog_tow_area">
        <div class="container">
           <div class="row blog_tow_row">
                <?php 
                            $q =  "select * from articles where type_a='institution' order by id_a DESC";
                            $r = $db -> query($q) ;
                            $cp=0;
