...
$pho= "select * from articles where id_a='".$_GET['id']."'";
$photor = $db -> query($pho) ;
$photoc = $photor -> fetch();
$Photo =$photoc['photo_a'];
$photo =null;
...
echo '</pre>';
  ...
  $sql2 = 'update articles set type_a = "'.$_POST['type_a'].'",titre_a="'.$_POST['titre_a'].'",description_a="'.$_POST['description_a'].'",texte_a="'.$_POST['texte_a'].'",date_a="'.$_POST['date_a'].'",photo_a="'.$Photo.'" where id_a="'.$_GET['id'].'" ';
      ...
      <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card-body">
              ...
              $q =  "select * from articles where id_a='".$_GET['id']."'";
              $r = $db -> query($q) ;
              while ($c = $r -> fetch())
              { 
              ...
              <form enctype="multipart/form-data"  method="post">
                        <div class="form-group">
                            <input name='type_a'type="text" class="form-control" value="<?php echo $c['type_a'];?>">
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                  <input name='titre_a'type="text" class="form-control" placeholder="Titre" value="<?php echo $c['titre_a'];?>">  
                                </div>
                                <div class="col-md-6">
                                  <input name='date_a' type="date" class="form-control" placeholder="Date" value="<?php echo $c['date_a'];?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input name='description_a'type="text" class="form-control" value="<?php echo $c['description_a'];?>">
                        </div>
                        <div class="form-group">
                            <textarea name="texte_a" class="form-control" id="summernoteEditor"  style="height: 200px"><?php echo $c['texte_a'];?></textarea>
                        </div>
                        <div class="form-group">
