        ...
        <div class="col-lg-12">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <form  enctype="multipart/form-data" action="traitement_note.php" method="post">
...
?>          
              ...
              <?php 
              $q =  "select nume,nom,prenom,dnaiss from etudiant where nom_classe='$nom_classe' order by nom,prenom";
              $r = $db -> query($q) ;
              while ($c = $r -> fetch())
              {
echo "<tr><th scope='row'>".$c['prenom']."</th><th scope='row'>".$c['nom']."</th><td>".$c['dnaiss']."</td><td><input type='hidden' name='nume[]' id='nume[]' value='".$c['nume']."'/><input name='note[]' id='note[]' width='10' /></td></tr>";
}
echo "</tbody>
