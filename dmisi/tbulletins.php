...
$req=$db->query("select distinct etudiant.nume,nom,prenom,dnaiss,nom_classe,noter.nume from etudiant,noter where etudiant.nume=noter.nume and nom_classe='$nom_classe'"); 
?>
...
while($ligne= $req->fetch()) {
  echo" <tr><th scope='row'>".$ligne['prenom']."</th><th scope='row'>".$ligne['nom']."</th><td>".$ligne['dnaiss']."</td>
      <td>";?>
<?php $req1=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='devoir'                                              and noter.nume='".$ligne['nume']."' and nom_module='bd' and semestre=1"); 
                           $ligne1= $req1->fetch();
    $req2=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='examen'                                              and noter.nume='".$ligne['nume']."' and nom_module='bd' and semestre=1"); 
                           $ligne2= $req2->fetch();
               $op1=$ligne1['note']*0.3; 
               $op2= $ligne2['note']*0.7;
               $op3=$op1+$op2;
      ...
      echo " </td>     
            <td>";
 $req1=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='devoir'                                              and noter.nume='".$ligne['nume']."' and nom_module='algo' and semestre=1"); 
                           $ligne1= $req1->fetch();
    $req2=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='examen'                                              and noter.nume='".$ligne['nume']."' and nom_module='algo' and semestre=1"); 
                           $ligne2= $req2->fetch();
               $op1=$ligne1['note']*0.3; 
               $op2= $ligne2['note']*0.7;
               $op4=$op1+$op2;
      ...
      echo " </td><th>"; echo $opa;?></th><th><?php if($opa<10)echo "nv";else echo "v";echo "</th>
             ...
             <td>";?>
<?php $req1=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='devoir'                                              and noter.nume='".$ligne['nume']."' and nom_module='java' and semestre=1"); 
                           $ligne1= $req1->fetch();
    $req2=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='examen'                                              and noter.nume='".$ligne['nume']."' and nom_module='java' and semestre=1"); 
                           $ligne2= $req2->fetch();
               $op1=$ligne1['note']*0.3; 
               $op2= $ligne2['note']*0.7;
               $op3=$op1+$op2;
      ...
      echo " </td>     
            <td>";
 $req1=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='devoir'                                              and noter.nume='".$ligne['nume']."' and nom_module='web' and semestre=1"); 
                           $ligne1= $req1->fetch();
    $req2=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='examen'                                              and noter.nume='".$ligne['nume']."' and nom_module='web' and semestre=1"); 
                           $ligne2= $req2->fetch();
               $op1=$ligne1['note']*0.3; 
               $op2= $ligne2['note']*0.7;
               $op4=$op1+$op2;
      ...
      echo " </td>     
            <td>";
  $req1=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='devoir'                                              and noter.nume='".$ligne['nume']."' and nom_module='uml' and semestre=1"); 
                           $ligne1= $req1->fetch();
    $req2=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='examen'                                              and noter.nume='".$ligne['nume']."' and nom_module='uml' and semestre=1"); 
                           $ligne2= $req2->fetch();
               $op1=$ligne1['note']*0.3; 
               $op2= $ligne2['note']*0.7;
               $op5=$op1+$op2;
      ...
      <td>
<?php $req1=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='devoir'                                              and noter.nume='".$ligne['nume']."' and nom_module='calnum' and semestre=1"); 
                           $ligne1= $req1->fetch();
    $req2=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='examen'                                              and noter.nume='".$ligne['nume']."' and nom_module='calnum' and semestre=1"); 
                           $ligne2= $req2->fetch();
               $op1=$ligne1['note']*0.3; 
               $op2= $ligne2['note']*0.7;
               $op3=$op1+$op2;
      ...
      echo" </td>     
            <td>";
 $req1=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='devoir'                                              and noter.nume='".$ligne['nume']."' and nom_module='stat' and semestre=1"); 
                           $ligne1= $req1->fetch();
    $req2=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='examen'                                              and noter.nume='".$ligne['nume']."' and nom_module='stat' and semestre=1"); 
                           $ligne2= $req2->fetch();
               $op1=$ligne1['note']*0.3; 
               $op2= $ligne2['note']*0.7;
               $op4=$op1+$op2;
      ...
      echo" </td><th>"; echo $opc;echo "</th><th>";?><?php if($opc<10)echo "nv";else echo "v";?></th>
             ...
             <td>
<?php $req1=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='devoir'                                              and noter.nume='".$ligne['nume']."' and nom_module='se' and semestre=1"); 
                           $ligne1= $req1->fetch();
    $req2=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='examen'                                              and noter.nume='".$ligne['nume']."' and nom_module='se' and semestre=1"); 
                           $ligne2= $req2->fetch();
               $op1=$ligne1['note']*0.3; 
               $op2= $ligne2['note']*0.7;
               $op3=$op1+$op2;
       ...
       echo"</td>     
            <td>";?>
<?php $req1=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='devoir'                                              and noter.nume='".$ligne['nume']."' and nom_module='reseau' and semestre=1"); 
                           $ligne1= $req1->fetch();
    $req2=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='examen'                                              and noter.nume='".$ligne['nume']."' and nom_module='reseau' and semestre=1"); 
                           $ligne2= $req2->fetch();
               $op1=$ligne1['note']*0.3; 
               $op2= $ligne2['note']*0.7;
               $op4=$op1+$op2;
      ...
      echo"</td>     
            <td>";?>
<?php $req1=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='devoir'                                              and noter.nume='".$ligne['nume']."' and nom_module='telecom' and semestre=1"); 
                           $ligne1= $req1->fetch();
    $req2=$db->query("select nom,prenom,note,nom_module,semestre,noter.nume from etudiant,noter where etudiant.nume=noter.nume and type_eva='examen'                                              and noter.nume='".$ligne['nume']."' and nom_module='telecom' and semestre=1"); 
                           $ligne2= $req2->fetch();
               $op1=$ligne1['note']*0.3; 
               $op2= $ligne2['note']*0.7;
               $op5=$op1+$op2;
