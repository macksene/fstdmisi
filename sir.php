...
?>
    ...
    <section class="banner_area" data-stellar-background-ratio="0.5">
        <h2>LA FORMATION EN SYSTEME D'INFORMATION REPARTI</h2>
        <ol class="breadcrumb">
                   ...
                   <div class="grid-sizer-2"></div>
                    <div class="single_facilities col-sm-7 painting building painting adversting">
                        <div class="who_we_area">
                            <div class="subtittle">
                                <h2>SYSTEME D'INFORMATION REPARTI</h2>
                            </div>
    ...
    <section class="our_team_area">
        <div class="container">
            <div class="tittle wow fadeInUp">
                <h2>PROFESSEURS</h2>
                <h4>Les specialistes qui dispensent les cours en business intelligence</h4>
            </div>
